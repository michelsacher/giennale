# -*- coding: utf-8 -*-
#
# fancyBox content documentation build configuration file, created by
# TYPO3 extension sphinx on Tue, 14 Apr 2015 16:53:26 +0200.
#
...
htmlhelp_basename = 'fancyboxcontentdoc'
...
latex_documents = [
    ('Index', 'fancyboxcontent.tex', u'fancyBox content',
...
pdf_documents = [
    ('Index', 'fancyboxcontent', u'fancyBox content',
     u'Raphael Zschorsch'),
]
...
texinfo_documents = [
    ('Index', 'fancyboxcontent', u'fancyBox content',
     u'Raphael Zschorsch', 'fancyBox content', 'One line description of project.',
     'Miscellaneous'),
]

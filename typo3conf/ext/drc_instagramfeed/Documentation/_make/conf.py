# -*- coding: utf-8 -*-
#
# DRC Instagram Feed documentation build configuration file, created by
# TYPO3 extension sphinx on Mon, 03 Oct 2016 12:02:44 +0530.
#
...
project = u'DRC Instagram Feed'
copyright = u'2016, DRC Systems'
...
htmlhelp_basename = 'drc_instagramfeeddoc'
...
latex_documents = [
    ('Index', 'drc_instagramfeed.tex', u'DRC Instagram Feed',
     u'DRC Systems', 'manual'),
]
...
pdf_documents = [
    ('Index', 'drc_instagramfeed', u'DRC Instagram Feed',
     u'DRC Systems'),
]
...
texinfo_documents = [
    ('Index', 'drc_instagramfeed', u'DRC Instagram Feed',
     u'DRC Systems', 'DRC Instagram Feed', 'One line description of project.',
     'Miscellaneous'),
]

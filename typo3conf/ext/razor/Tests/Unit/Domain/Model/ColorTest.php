...
/**
 * Test case for class \RZ\Razor\Domain\Model\Color.
 *
...
class ColorTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    ...
    /**
     * @var \RZ\Razor\Domain\Model\Color
     */
    protected $subject = null;

    protected function setUp()
    {
        $this->subject = new \RZ\Razor\Domain\Model\Color();
    }
    ...
    {
        $this->assertSame('', $this->subject->getColor());
    }
    ...
    public function setColorForStringSetsColor()
    {
        ...
        $this->assertAttributeEquals('Conceived at T3CON10', 'color', $this->subject);
    }
    ...
    {
        $this->assertSame('', $this->subject->getCss());
    }
    ...
    public function setCssForStringSetsCss()
    {
        ...
        $this->assertAttributeEquals('Conceived at T3CON10', 'css', $this->subject);
    }

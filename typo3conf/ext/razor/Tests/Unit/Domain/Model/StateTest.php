...
/**
 * Test case for class \RZ\Razor\Domain\Model\State.
 *
...
class StateTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    ...
    /**
     * @var \RZ\Razor\Domain\Model\State
     */
    protected $subject = null;

    protected function setUp()
    {
        $this->subject = new \RZ\Razor\Domain\Model\State();
    }
    ...
    {
        $this->assertSame('', $this->subject->getActive());
    }
    ...
    public function setActiveForStringSetsActive()
    {
        ...
        $this->assertAttributeEquals('Conceived at T3CON10', 'active', $this->subject);
    }
